...
from tlk.models.text_classification.text_classification_model import TextClassificationModel
...
class TFHubTextClassificationModel(TextClassificationModel, TFHubModel):
    ...
    def __init__(self, model_name: str):
        tfhub_model_map = read_json_file(os.path.join(
            TLK_BASE_DIR, "models/configs/tfhub_text_classification_models.json"))
