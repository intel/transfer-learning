...
@pytest.mark.parametrize('accuracy_criterion,valid',
                         [[0.1, True],
                          ...
                          [1.434, False],
                          ['foo', False]])
def test_tf_image_classification_config_accuracy_criterion(accuracy_criterion, valid):
    """
    Tests an Intel Neural Compressor config with good and bad accuracy_criterion_relative values
    """
...
@pytest.mark.parametrize('timeout,valid',
                         [[0.1, False],
                          ...
                          [60, True],
                          ['foo', False]])
def test_tf_image_classification_config_timeout(timeout, valid):
    """
...
@pytest.mark.parametrize('max_trials,valid',
                         [[0.1, False],
                          ...
                          [60, True],
                          ['foo', False]])
def test_tf_image_classification_config_max_trials(max_trials, valid):
    """
